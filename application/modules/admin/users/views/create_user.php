						...
						<div class="col-md-8 mx-auto box-shaow">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group b-grey">											
												<input type="text" class="form-control width-100"  id="user_name" name="user_name" value="<?php set_value('user_name')?>" placeholder="Enter Resturant Name" required>
							...
							<div class="row bb-grey">
								<div class="col-md-12 m-3">
									...
									<div class="form-group b-grey">
										...
										<input type="email" class="form-control" name="user_email" placeholder="Enter Email" value="<?php echo set_value('user_email');?>" required/>
										<div class="invalid-feedback">
								...
								<div class="col-md-12 m-3">
									<div class="form-group b-grey">
										...
										<input type="text" class="form-control"  name="user_phone" value="<?php echo set_value('user_phone');?>" placeholder="Enter Contact number" required />
										<div class="invalid-feedback">
                                ...
                                <div class="col-md-12 m-3">
									<div class="form-group b-grey">
                                        ...
                                        <input  id="basicFlatpickr"  class="form-control flatpickr flatpickr-input active basicFlatpickr" type="text"  placeholder="Enter Joining date" name="user_joining" value="<?php echo set_value('user_joining')?>" required />
										<div class="invalid-feedback">
                                        ...
                                        <select name="user_role" class="form-control">
                                            ...
                                            <?php
                                             ...
                                             $role=  $this->role_model->view_role($params);
                                              foreach($role as $rl){                                            
                                            ?>
                                            <option value="<?php echo $rl->ut_id; ?>"><?php echo $rl->ut_name;?></option>
                                            <?php } ?>
                                        </select>									
										<div class="invalid-feedback">
							...
							<div class="row bb-grey">
								<div class="col-md-12 m-3">
									...
									<div class="form-group b-grey">
										<input type="text" class="form-control "  name="user_experience" value="<?php echo set_value('user_experience');?>" placeholder="Experience"  required />
										<div class="invalid-feedback">
