<?php
$sr     =   $this->session->userdata("active-deactive-cuisine");
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php if($ct == '1'){?>
                    <td> 
                    <?php if($sr == '1'){?>
                    <a class="<?php echo $textico;?>" href="javascript:void(0);" onclick="activeform($(this),'Ajax-Cuisine-Active')" fields="<?php echo $ve->cuisine_id;?>" data-toggle='tooltip' title="<?php echo $vadv;?>">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle text-primary"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                    ...
                    <?php }  if($ur == '1'){?>
                        <a href='<?php echo adminurl("Update-Cuisine/".$ve->cuisine_id);?>' data-toggle='tooltip' data-original-title="Update Role" class="text-success tip-left">
                ...
                echo '<tr class="text-center text-danger"><td colspan="5"><i class="zmdi zmdi-info-outline"></i> Cuisines are  not available</td></tr>';
            }
            ?>
        </tbody>
    </table>
