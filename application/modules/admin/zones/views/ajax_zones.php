<?php
$sr     =   $this->session->userdata("active-deactive-zone");
$cr     =   $this->session->userdata("create-zone");
$ur     =   $this->session->userdata("update-zone");
$dr     =   $this->session->userdata("delete-zone");
$ct     =   "0";
if($ur  == 1 || $dr == '1' || $sr == 1){
        $ct     =   1;
}
...
<div class="table-responsive"> 
    <table class="table table-striped table-hover js-basic-example tablehrcover" id="myTable">
        <thead>
            <tr id="filters">
                <th>S.No</th>
                <th><a href="javascript:void(0);" data-type="order" data-field="zone_name" urlvalue="<?php echo adminurl('viewRole/');?>" onclick="getdatafiled($(this))">Zone Name <i class="zmdi font-14 zmdi-sort pull-right"></i></a> </th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $ve->zone_name;?></td>
                <td><?php echo $vdata;?></td>
                <?php if($ct == '1'){?>
                    <td>
                    <a class="<?php echo $textico;?>" href="javascript:void(0);" onclick="activeform($(this),'Active-Deactive-Zone')" fields="<?php echo $ve->zone_id;?>" data-toggle='tooltip' title="<?php echo $vadv;?>">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle text-primary"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                    ...
                    <?php }  if($ur == '1'){?>
                        <a href='<?php echo adminurl("Update-Zone/".$ve->zone_id);?>' data-toggle='tooltip' data-original-title="Update Zone" class="text-success tip-left">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                        </a>
                    <?php } if($dr == '1'){?>
                    <a href="javascript:void(0);" onclick="confirmationDelete($(this),'Zone')" data-toggle='tooltip' attrvalue="<?php echo adminurl("Delete-Zone/".$ve->zone_id);?>" data-original-title="Delete Zone" class="text-danger">
