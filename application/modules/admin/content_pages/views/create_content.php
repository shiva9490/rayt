                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="page_title" type="text" class="form-control" placeholder="Page Title" value="<?php echo set_value('page_title');?>" required="" autocomplete="off" />
                                ...
                                <div class="col-md-12 mt-3">                              
                                    <div class="form-group ">
                                        ...
                                        <textarea id="page-description" name="page_description" class="form-control" rows="3"><?php echo set_value('page_description');?></textarea>
