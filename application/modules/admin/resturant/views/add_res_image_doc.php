    ...
    <div class="col-lg-12">
      <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-12">Add Restaurant Images</div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="custom-file-container" data-upload-id="myFirstImage">
                                                ...
                                                <label class="custom-file-container__custom-file" >
                                                    <input type="file" class="custom-file-container__custom-file__custom-file-input"  name="files[]" accept="image/*" multiple required>
                                                    <input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
                                                    <span class="custom-file-container__custom-file__custom-file-control"></span>
                                                    <div class="invalid-feedback">
                                                        Please provide a valid Restaurant Main Image.
                                                    </div>
                                                </label>
