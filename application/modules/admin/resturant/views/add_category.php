...
<div class="modal-body" style="height: auto;">
    ...
    <input type="text" name="category" id="category" placeholder="category" class="form-control category"><br>
    <input type="text" name="category_a" id="category_a" placeholder="الفئة" class="form-control category_a"><br>
</div>
<div class="modal-footer">
    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Close</button>
    <button type="button" class="btn btn-primary categorybutton" onclick="addingcategortss()" >Save</button>
