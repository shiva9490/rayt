							    ...
							    <div class="row">
    							    <?php 
    							        ...
    							        if(is_array($addon) && count($addon) > 0){
    							            ...
    							            ?> 
    							            <div class="col-md-3">
    							                <a data-toggle="modal" class="addon<?php echo $ad->addon_id;?>" data-ids<?php echo $ad->addon_id;?>="<?php echo $ad->addon_id;?>"  onclick="addons('<?php echo $ad->addon_id;?>')" data-ids<?php echo $ad->addon_id;?>="<?php echo $ad->addon_id;?>" data-title<?php echo $ad->addon_id;?>="<?php echo $ad->addon_name;?>" ><!--data-target=".bd-example-modal-lgs"-->
    							            ...
    							            ?>
    							            <div class="col-md-3">
        							            <a data-toggle="modal" class="addon0" onclick="addons('0')" data-ids0="<?php echo $ad->addon_id;?>" data-ids0="" data-title0="" >
							    ...
							    <div class="row">
    							    <?php 
    							        ...
    							        if(is_array($variant) && count($variant) >0){
    							            ...
    							            ?>
    							            <div class="col-md-4">
        							            <a class="variant0" onclick="variants('0')" data-title0="" data-ids0="0">
        							                <blockquote class="blockquote media-object">
                                                        <div class="media">
                                                            <div class="usr-img mr-2">
                                                                <img alt="avatar" src="<?php echo base_url().'upload/addon/'.$ad->addon_image_path;?>" class="br-30">
