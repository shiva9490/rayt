							...
							<div class="row bb-grey">
											...
											<div class="col-md-3">
												<div class="n-chk">
                                                    <label class="new-control new-radio square-radio new-radio-text">
                                                        <input type="radio" class="new-control-input" name="veg_type" value="<?php echo $veg;?>" <?php set_radio('veg_type', $veg); ?> <?php if($veg == $view['resturant_items_type']){echo 'checked';} ?>>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group b-grey">
												...
												<input type="text" class="form-control width-100"  id="Resturantname" name="itemname" value="<?php echo $view['resturant_items_name'];?>" placeholder="Enter Item Name" required>
												<div class="invalid-feedback">
								...
								<div class="col-md-12 m-3">
									<div class="form-group b-grey">
										...
										<textarea id="textarea" class="form-control textarea" maxlength="225" rows="3" name="details" placeholder="Basic Details..."><?php echo $view['resturant_items_desc'];?></textarea>
                                        <div class="invalid-feedback">
								...
								<div class="col-md-12 m-3">
									<div class="custom-file-container" data-upload-id="myFirstImage">
										<label>Iteam Image (Single File)  <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
										...
										<div class="custom-file-container__image-preview"><img src="<?php echo base_url().'upload/resturants/'.$view['resturant_items_image']?>"></div>
									</div>
							...
							<div class="row bb-grey">
										...
										<select class="form-control vat" name="vat" id="exampleFormControlSelect1" onchange="itemamount()" />
											...
											<?php 
												...
												if(is_array($vat) && count($vat) >0){
													foreach($vat as $vat){
														if($vat->vat == $view['resturant_items_vat']){
															?>
																<option value="<?php echo $vat->vat?>" selected><?php echo $vat->vat?>%</option>
															<?php
														}else{
											?>
								...
								<div class="col-md-3">
									<div class="form-group b-grey">
										...
										<input type="text" class="form-control total"  name="final_amount" placeholder="Final Price" value="<?php echo $view['resturant_items_packing'];?>" required />
									</div>
								</div>
							</div><br>
							<div class="row bb-grey ">
							    ...
							    <div class="row">
    							    <?php 
    							        $par['whereCondition']= "addon_acde LIKE 'Active'";
