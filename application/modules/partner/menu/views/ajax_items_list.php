		<div class="col-md-12 col-sm-12 col-12 text-right">
		    <?php 
		        ...
		        if($cat!=""){
		    ?>
            <a href="<?php echo partnerurl('Add-Items/'.$cat);?>" class="btn btn-primary mb-2 mr-2" >
              +Add Item
            </a>
            <?php } ?>
        </div>
			...
			<div class="todo-item-inner">
				...
				<div class="priority-dropdown custom-dropdown-icon">
					<label class="switch s-secondary  mb-4 mr-2">
                        <input type="checkbox" name="itemid" id="itemid<?php echo $view->resturant_items_id;?>" data-status<?php echo $view->resturant_items_id;?>="<?php echo $view->resturant_items_abc;?>" onchange="itemchange('<?php echo $view->resturant_items_id;?>')" <?php echo $stat;?>>
				...
				<div class="action-dropdown custom-dropdown-icon">
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuLink-2">
							<a class="edit dropdown-item" href="<?php echo partnerurl('Update-Items/'.$view->resturant_items_id);?>">Edit</a>
