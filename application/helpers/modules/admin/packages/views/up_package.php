...
<div class="row pt-2 pb-2">
   <div class="col-sm-12">
      ...
      <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item"><a href="<?php echo adminurl("Packages");?>">Packages</a></li>
                 ...
                 <div class="row">
                     <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            foreach($vsp as $fe){
                                ?>
                            <input name="package_type" type="radio"  value="<?php echo $fe;?>" <?php echo ($fe == $view["package_type"])?"checked='checked'":"";?> required=""/> <?php echo $fe;?>
                                <?php
                            }
                            ?>
                            </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="packagename" type="text" class="form-control text-capitalize" placeholder="Package Name" value="<?php echo (count($view) > 0)?$view["package_name"]:set_value('packagename');?>" required="" minlength="3" maxlength="50"/>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="package_price" type="text" class="form-control input_geo text-capitalize" placeholder="Price" value="<?php echo (count($view) > 0)?$view["package_price"]:set_value('package_price');?>" required="" minlength="1" maxlength="50"/>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="package_coins" type="text" class="form-control input_geo text-capitalize" placeholder="Coins" value="<?php echo (count($view) > 0)?$view["package_coins"]:set_value('package_coins');?>" required=""/>
