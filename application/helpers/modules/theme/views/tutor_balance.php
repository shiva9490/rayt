...
<section class="eventsgrid">
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <div class="imgvsl">
                    <img src="<?php echo $this->config->item("themeassets");?>wallet.png" class="img img-responsive img-100"/>
                    <div class="text-center mt-10 text-success font10"><i class="fas fa-coins text-center"></i> <?php echo $regwallet;?></div>
                </div>
            </div>
            <div class="col-md-10">
